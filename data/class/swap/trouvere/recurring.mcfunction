$data modify storage data:player$(player) class set value trouvere
scoreboard players operation @s passive.s = @s lastPassive.trouvere
scoreboard players operation @s mbt.s = @s lastMBT.trouvere
scoreboard players operation @s f.s = @s lastF.trouvere
scoreboard players operation @s q.s = @s lastQ.trouvere
