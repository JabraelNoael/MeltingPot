$data modify storage data:player$(player) class set value druid
scoreboard players operation @s passive.s = @s lastPassive.druid
scoreboard players operation @s mbt.s = @s lastMBT.druid
scoreboard players operation @s f.s = @s lastF.druid
scoreboard players operation @s q.s = @s lastQ.druid
