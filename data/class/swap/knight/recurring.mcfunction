$data modify storage data:player$(player) class set value knight
scoreboard players operation @s passive.s = @s lastPassive.knight
scoreboard players operation @s mbt.s = @s lastMBT.knight
scoreboard players operation @s f.s = @s lastF.knight
scoreboard players operation @s q.s = @s lastQ.knight
