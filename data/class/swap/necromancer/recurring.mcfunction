$data modify storage data:player$(player) class set value necromancer
scoreboard players operation @s passive.s = @s lastPassive.necromancer
scoreboard players operation @s mbt.s = @s lastMBT.necromancer
scoreboard players operation @s f.s = @s lastF.necromancer
scoreboard players operation @s q.s = @s lastQ.necromancer
