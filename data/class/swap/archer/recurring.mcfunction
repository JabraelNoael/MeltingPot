$data modify storage data:player$(player) class set value archer
scoreboard players operation @s passive.s = @s lastPassive.archer
scoreboard players operation @s mbt.s = @s lastMBT.archer
scoreboard players operation @s f.s = @s lastF.archer
scoreboard players operation @s q.s = @s lastQ.archer
