$data modify storage data:player$(player) class set value flower_warrior
scoreboard players operation @s passive.s = @s lastPassive.flower_warrior
scoreboard players operation @s mbt.s = @s lastMBT.flower_warrior
scoreboard players operation @s f.s = @s lastF.flower_warrior
scoreboard players operation @s q.s = @s lastQ.flower_warrior
