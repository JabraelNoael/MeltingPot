$data modify storage data:player$(player) class set value rishi
scoreboard players operation @s passive.s = @s lastPassive.rishi
scoreboard players operation @s mbt.s = @s lastMBT.rishi
scoreboard players operation @s f.s = @s lastF.rishi
scoreboard players operation @s q.s = @s lastQ.rishi
