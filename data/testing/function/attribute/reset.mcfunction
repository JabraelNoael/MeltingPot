...
#attribute @s flying_speed base set ?
#attribute @s follow_range base set ?
...
#attribute @s spawn_reinforcements base set ?
...
attribute @s water_movement_efficiency base set 3