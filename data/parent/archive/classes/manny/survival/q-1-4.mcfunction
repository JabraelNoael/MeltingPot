...
execute at @e[tag=marker.manny.q-1] run particle block dirt ^ ^ ^4 0 0 0 0 4 force
execute at @e[tag=marker.manny.q-1] run particle block dirt ^ ^ ^-4 0 0 0 0 4 force
execute at @e[tag=marker.manny.q-1] run particle block dirt ^4 ^ ^ 0 0 0 0 4 force
execute at @e[tag=marker.manny.q-1] run particle block dirt ^-4 ^ ^ 0 0 0 0 4 force
scoreboard players set @a[tag=manny] q.cd 10
scoreboard players set @a[tag=manny] q.cdc 0
execute if entity @e[tag=marker.manny.q-1] run schedule function parent:classes/manny/survival/q-1-4 1t