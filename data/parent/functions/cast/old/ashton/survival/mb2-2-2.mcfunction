...
execute as @s run scoreboard players remove @s mobhealth 5
...
tag @s[tag=ashton.sniper] add ashton.marked
tag @s remove ashton.sniper
execute as @s[scores={ashton.passive=5..}] at @s run function parent:classes/ashton/survival/mb2-2-3