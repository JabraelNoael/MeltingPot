...
execute as @s run scoreboard players remove @s mobhealth 32
...
tag @s remove ashton.ultimate
execute as @s[scores={ashton.passive=5..}] at @s run function parent:classes/ashton/survival/q-2-3